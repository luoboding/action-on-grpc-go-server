...
type ListOrdersRequest struct {
	...
	// 商品名称
	ProdcutName string `protobuf:"bytes,5,opt,name=prodcut_name,json=prodcutName,proto3" json:"prodcut_name,omitempty"`
}
...
func (x *ListOrdersRequest) GetProdcutName() string {
	if x != nil {
		return x.ProdcutName
	}
	return ""
}
...
var file_orders_orders_proto_rawDesc = []byte{
	...
	0x4e, 0x6f, 0x12, 0x21, 0x0a, 0x0c, 0x70, 0x72, 0x6f, 0x64, 0x63, 0x75, 0x74, 0x5f, 0x6e, 0x61,
	0x6d, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x70, 0x72, 0x6f, 0x64, 0x63, 0x75,
